...
\begin{questions}
    ...
    % TODO: question 5
        \begin{parts}
            \part[6]
                A Hilbert space $\mathcal{H}$ may be characterized as a Banach space in which the so-called parallelogram law holds; that is, for each pair of vectors \textbf{x} and \textbf{y} in $\mathcal{H}$, we have 
                \[\|\textbf{x}+\textbf{y}\|^2_\mathcal{H} + \|\textbf{x}-\textbf{y}\|^2_\mathcal{H} = 2 \cdot \|\textbf{x}\|^2_\mathcal{H} + 2\cdot \|\textbf{y}\|_\mathcal{H}^2.\]
